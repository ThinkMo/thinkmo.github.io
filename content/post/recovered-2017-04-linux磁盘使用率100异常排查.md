...
<h2 id="du--h---max-depth1--x-查看目录磁盘占用情况-x排除挂载的其他磁盘">du -h –max-depth=1 -x 查看/目录磁盘占用情况(-x排除挂载的其他磁盘)</h2>
<p><img alt="du" src="https://i.imgur.com/OZmT6xt.png"/></p>
<h2 id="df查看磁盘使用率在94">df查看/磁盘使用率在94%</h2>
<p><img alt="df" src="https://i.imgur.com/8xA5AWA.png"/></p>

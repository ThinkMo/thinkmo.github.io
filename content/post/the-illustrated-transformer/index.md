...
![image.png](images/mtz9e0b8-image.png)
...
![image.png](images/mtz9mspv-image.png)
...
![image.png](images/mtz9xp12-image.png)
...
![image.png](images/mtza0lc8-image.png)
...
![image.png](images/mtza5sue-image.png)
...
![image.png](images/mtza7d8m-image.png)
...
![image.png](images/mtzacijz-image.png)
...
![image.png](images/mtzahzb6-image.png)
...
![image.png](images/mtzajq3d-image.png)

*为了让模型感知词的顺序，我们加入了位置编码向量，这些向量中的数值遵循特定的模式。*

假设嵌入向量的维度为 4，那么实际的位置编码会如下所示：

![image.png](images/mtzam2qp-image.png)
...
![image.png](images/mtzaopgm-image.png)
...
![image.png](images/mtzqxrfv-image.png)
...
![image.png](images/mtzr3xta-image.png)
...
![image.png](images/mtzr80tj-image.png)

*图中展示了一个示例句子的目标概率分布，模型将以这些分布为目标进行训练。*

在足够大的数据集上对模型进行充分训练后，我们希望它生成的概率分布如下所示：

![image.png](images/mtzr9xbt-image.png)
